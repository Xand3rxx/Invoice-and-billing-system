...
<!--          <?php var_dump($_REQUEST); ?>-->
        <div class="table-responsive">
          ...
          <div class="container-fluid">
            <div class="navbar-header" >
              <a class=" navbar-brand" href="invoice.php?add=1">Create Invoice</a>
            </div>
          </div>
        </nav>
      ...
      ?>
        <nav class="navbar navbar-default card">
          <div class="container-fluid">
            <div class="navbar-header" >
              <a class=" navbar-brand" href="#">Invoice and Billing System</a>
            </div>
          </div>
        </nav>
      ...
      <br />
      <div align="right">
        <a href="invoice.php?add=1" class="btn btn-primary">New Invoice</a>
      </div>
      <br />
      <table id="data-table" class="table table-bordered table-striped card">
        <thead>
          <tr>
            <th>Invoice No.</th>
            <th>Invoice Date</th>
